package com.globallink.ctm.db.service.impl;
...
import com.globallink.ctm.db.dao.RoleDAO;
import com.globallink.ctm.db.dao.UserDAO;
import com.globallink.ctm.db.entity.AuditTimes;
...
public class UserDBService implements IUserDBService {
	...
	public List<com.globallink.ctm.model.User> getUsers() {
		...
		List<com.globallink.ctm.model.User> clientUsers = users.stream().map(user -> createClientUser(user)).collect(Collectors.toList());
		return clientUsers;
	}
	
	private com.globallink.ctm.model.User createClientUser(User user) {
		com.globallink.ctm.model.User clientUser = new com.globallink.ctm.model.User();
