...
import com.lps.db.service.IUserDBService;
...
public class UserDBService implements IUserDBService {
	...
	public List<com.lps.model.User> getUsers() {
		...
		List<com.lps.model.User> clientUsers = users.stream().map(user -> createClientUser(user)).collect(Collectors.toList());
		return clientUsers;
	}
	
	private com.lps.model.User createClientUser(User user) {
		com.lps.model.User clientUser = new com.lps.model.User();
